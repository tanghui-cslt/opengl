...
int main(int argc, char** argv)
{
	...
	// Section3 准备纹理对象
	// Step1 创建并绑定纹理对象
	GLuint textureId = TextureHelper::load2DTexture("wood.png");
	GLuint textureId1 = TextureHelper::load2DTexture("cat.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1i(glGetUniformLocation(shader.programId, "tex1"), 1); // 设置纹理单元为1号
